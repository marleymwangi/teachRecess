      ...
      <Html lang="en">
        <Head>
          ...
          <meta
            ...
            content="Recess is a platform that improves the communication between parents and the school."
          />
          <meta name="twitter:image" content="assets/logo1.webp" />
        ...
        <div
            id="loader"
            className="h-screen w-full fixed bg-cyan-600 z-50 flex justify-center items-center"
          >
            <h1 className="text-5xl text-white font-bold">Recess</h1>
          </div>
          <Main />
          <NextScript />
        </body>
